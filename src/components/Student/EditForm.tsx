...
const EditForm: React.FC<EditFormProps> = ({ field, initialValue, onCancel, onSubmit }) => {
  ...
  return (
    <Form form={form} onFinish={handleFinish} initialValues={{ [field.toLowerCase().replace(/ /g, '_')]: initialValue }}>
      <Form.Item
        label={field}
