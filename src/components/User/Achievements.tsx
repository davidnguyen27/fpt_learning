      ...
      <div className="grid grid-cols-2 gap-x-7 gap-y-7 max-md:grid-cols-1">
        <article className="rounded-md bg-slate-200 p-4 drop-shadow-sm">
          <div className="mb-7 text-center text-2xl">
            <i className="fa-solid fa-display rounded-md bg-red-200 p-6"></i>
          </div>
        ...
        <article className="rounded-md bg-slate-200 p-4 drop-shadow-sm">
          <div className="mb-7 text-center text-2xl">
            <i className="fa-solid fa-clock-rotate-left rounded-md bg-red-200 p-6"></i>
          </div>
          <h3 className="text-center text-xl font-semibold">
            Go at your own pace
          </h3>
        ...
        <article className="rounded-md bg-slate-200 p-4 drop-shadow-sm">
          <div className="mb-7 text-center text-2xl">
            <i className="fa-solid fa-user-check rounded-md bg-red-200 p-6"></i>
          </div>
          <h3 className="text-center text-xl font-semibold">
        ...
        <article className="rounded-md bg-slate-200 p-4 drop-shadow-sm">
          <div className="mb-7 text-center text-2xl">
            <i className="fa-regular fa-circle-play rounded-md bg-red-200 p-6"></i>
          </div>
          <h3 className="text-center text-xl font-semibold">
